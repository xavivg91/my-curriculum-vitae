 ...
 * Hard-working person with problem-solving skills, self-taught, curious, fast learner and always eager to keep improving
...
tribble(
  ...
  "Business Intelligence Developer at HP Inc.", "February 2019 - Present", "Capgemini ", "Sant
  Cugat del Vallès, Catalonia, Spain", "Translating business needs into technical
  specifications",
  "Business Intelligence Developer at HP Inc.", "February 2019 - Present", "Capgemini ", "Sant
  Cugat del Vallès, Catalonia, Spain", "Using data visualization tools to provide reports and
  dashboards",
  "Business Intelligence Developer at HP Inc.", "February 2019 - Present", "Capgemini ", "Sant
  Cugat del Vallès, Catalonia, Spain", "Supporting and maintaining the current dashboards
  portfolio and process automation",
  "Business Intelligence Developer at HP Inc.", "February 2019 - Present", "Capgemini ", "Sant
  Cugat del Vallès, Catalonia, Spain", "Comparing data in different systems to ensure it is           consistent (cross-system consistency checks)",
  "Business Intelligence Developer at HP Inc.", "February 2019 - Present", "Capgemini ", "Sant
  Cugat del Vallès, Catalonia, Spain", "TOOLS: Power BI, SQL Server Management Studio, SSAS,
  SSIS, QlikView, Tableau, Microsoft Excel",

  "Teaching Assistant", "February 2020 - Present", "Universitat Oberta de Catalunya",
  "Barcelona, Catalonia, Spain", "Giving support to the students in an introductory course of
  the Master's degree in Data Science: Data Types and Life Cycle (6 ECTS)", 
  "Teaching Assistant", "February 2020 - Present", "Universitat Oberta de Catalunya",
...
tribble(
  ~ with, ~ what, ~ oo, ~ aa, 
  "Problem-solving, Willingness to learn, Work Ethic, Autonomy, Logical thinking,
  Detail-Oriented, Multitasking, Perseverance, Curiosity, Creativity, Humility", " ", "Soft
  Skills", " ",
  "Data Analysis, Data Visualization, Data Mining, Programming, Machine Learning, Business
  Intelligence, Mathematics, Statistics", " ", "Hard Skills", " ",
  ...
  (SSIS)", " ", "Business Intelligence Tools", " ",
...
tribble(
  ...
  BCN portal:
  https://opendata-ajuntament.barcelona.cat/ca/world-data-viz-challenge-2020-barcelona-kobe-f
  inalistes",
